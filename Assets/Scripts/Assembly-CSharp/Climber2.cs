...
public class Climber2 : MonoBehaviour
{
	...
	private DistanceJoint2D distanceJoint_R;
	...
	private void Start()
	{
		...
		distanceJoint_R = body.GetComponent<DistanceJoint2D>();
		distanceJoint_R.distance = armDistance;
		distanceJoint_R.anchor = shoulder_R.localPosition;
	...
	private void FixedUpdate()
	{
		...
		JointPhysics(vector2 * sqrMagnitude / Time.fixedDeltaTime, Time.fixedDeltaTime);
	}
	...
	{
		float num = 0f;
		Vector2 vector = -totalForce - distanceJoint_R.reactionForce + new Vector2(0f, 0f - num);
